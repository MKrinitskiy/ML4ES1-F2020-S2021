...
<p align='justify'>
    В связи с поступающими вопросами и запросами я должен еще раз обозначить свою позицию: я не распространяю пиратские электронные копии рекомендуемых книг.
    <br>
